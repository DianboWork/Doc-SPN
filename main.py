...
if __name__ == '__main__':
    ...
    data_arg.add_argument('--dataset_name', type=str, default="DWIE-exact")
    data_arg.add_argument('--train_file', type=str, default="./data/DWIE/train.json")
    data_arg.add_argument('--test_file', type=str, default="./data/DWIE/test.json")
    ...
    data_arg.add_argument('--bert_directory', type=str, default="./longformer")
    ...
    learn_arg.add_argument('--num_generated_triples', type=int, default=400)
    learn_arg.add_argument('--num_decoder_layers', type=int, default=1)
